(()=>{var a={};a.id=91,a.ids=[91],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},3033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3421:(a,b,c)=>{"use strict";Object.defineProperty(b,"I",{enumerable:!0,get:function(){return g}});let d=c(1237),e=c(5088),f=c(7679);async function g(a,b,c,g){if((0,d.isNodeNextResponse)(b)){var h;b.statusCode=c.status,b.statusMessage=c.statusText;let d=["set-cookie","www-authenticate","proxy-authenticate","vary"];null==(h=c.headers)||h.forEach((a,c)=>{if("x-middleware-set-cookie"!==c.toLowerCase())if("set-cookie"===c.toLowerCase())for(let d of(0,f.splitCookiesString)(a))b.appendHeader(c,d);else{let e=void 0!==b.getHeader(c);(d.includes(c.toLowerCase())||!e)&&b.appendHeader(c,a)}});let{originalResponse:i}=b;c.body&&"HEAD"!==a.method?await (0,e.pipeToNodeResponse)(c.body,i,g):i.end()}}},4870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5054:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>A,patchFetch:()=>z,routeModule:()=>v,serverHooks:()=>y,workAsyncStorage:()=>w,workUnitAsyncStorage:()=>x});var d={};c.r(d),c.d(d,{GET:()=>u});var e=c(5736),f=c(9117),g=c(4044),h=c(9326),i=c(2324),j=c(261),k=c(4290),l=c(5328),m=c(8928),n=c(6595),o=c(3421),p=c(7679),q=c(1681),r=c(3446),s=c(6439),t=c(1356);function u(){return new Response(`<!doctype html>
<html lang="th">
  <head>
    <meta charset="utf-8" />
    ...
    <style>
      ...
      .right::before {
        ...
        left: -90px;
        width: 200px;
        background: linear-gradient(135deg, rgba(255,255,255,0) 45%, rgba(255,255,255,1) 46%);
        pointer-events: none;
      }
      .big404 {
        position: relative;
      ...
      @media (max-width: 759px) {
        ...
        .left { text-align: center; padding: 26px 22px 18px; }
        .logo { margin: 0 auto; }
        .right { padding: 18px 22px 26px; }
        ...
        <div class="headline">
          <div class="left">
            ...
            <div class="fineprint">
              ...
              <a class="urlpill" href="https://employee-management-9yicp.kinsta.app/login">https://employee-management-9yicp.kinsta.app/qr-tools</a>
